...
Mientras que un módulo de memoria es más veloz, ya que permite acceder a la información almacenada temporalmente en él en lapsos de tiempo de nanosegundos, a su vez la velocidad depende del reloj del bus que conecta la memoria con el microprocesador.\cite{tallerwebsite}
